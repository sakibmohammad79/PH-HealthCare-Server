...
ALTER COLUMN "pragnancyStatus" DROP NOT NULL,
ALTER COLUMN "pragnancyStatus" SET DEFAULT false,
ALTER COLUMN "mentalHealthHistory" DROP NOT NULL,
ALTER COLUMN "immunizationStatus" DROP NOT NULL,
ALTER COLUMN "hasFastSurgeries" DROP NOT NULL,
ALTER COLUMN "hasFastSurgeries" SET DEFAULT false,
